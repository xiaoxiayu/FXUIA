...
_MAGICWANDREQUEST = _descriptor.Descriptor(
  name='MagicWandRequest',
  full_name='imageprocess.MagicWandRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='img', full_name='imageprocess.MagicWandRequest.img', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='posx', full_name='imageprocess.MagicWandRequest.posx', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='posy', full_name='imageprocess.MagicWandRequest.posy', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lodif', full_name='imageprocess.MagicWandRequest.lodif', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hidif', full_name='imageprocess.MagicWandRequest.hidif', index=4,
...
_REFLOWTEXTREPLY = _descriptor.Descriptor(
  name='ReflowTextReply',
  full_name='imageprocess.ReflowTextReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sim', full_name='imageprocess.ReflowTextReply.sim', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='txt0', full_name='imageprocess.ReflowTextReply.txt0', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='txt1', full_name='imageprocess.ReflowTextReply.txt1', index=2,
...
_TXTCMPREQUEST = _descriptor.Descriptor(
  name='TxtCmpRequest',
  full_name='imageprocess.TxtCmpRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='txt0', full_name='imageprocess.TxtCmpRequest.txt0', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='txt1', full_name='imageprocess.TxtCmpRequest.txt1', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMGCMPREQUEST = _descriptor.Descriptor(
  name='ImgCmpRequest',
  full_name='imageprocess.ImgCmpRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='img0', full_name='imageprocess.ImgCmpRequest.img0', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='img1', full_name='imageprocess.ImgCmpRequest.img1', index=1,
...
_OCRREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filter', full_name='imageprocess.OcrRequest.filter', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='zoom', full_name='imageprocess.OcrRequest.zoom', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['MagicWandRequest'] = _MAGICWANDREQUEST
DESCRIPTOR.message_types_by_name['ReflowTextReply'] = _REFLOWTEXTREPLY
DESCRIPTOR.message_types_by_name['TxtCmpRequest'] = _TXTCMPREQUEST
DESCRIPTOR.message_types_by_name['ImgCmpRequest'] = _IMGCMPREQUEST
...
MagicWandRequest = _reflection.GeneratedProtocolMessageType('MagicWandRequest', (_message.Message,), dict(
  DESCRIPTOR = _MAGICWANDREQUEST,
  __module__ = 'imageprocess_pb2'
  # @@protoc_insertion_point(class_scope:imageprocess.MagicWandRequest)
  ))
_sym_db.RegisterMessage(MagicWandRequest)

ReflowTextReply = _reflection.GeneratedProtocolMessageType('ReflowTextReply', (_message.Message,), dict(
  DESCRIPTOR = _REFLOWTEXTREPLY,
  __module__ = 'imageprocess_pb2'
  # @@protoc_insertion_point(class_scope:imageprocess.ReflowTextReply)
  ))
_sym_db.RegisterMessage(ReflowTextReply)

TxtCmpRequest = _reflection.GeneratedProtocolMessageType('TxtCmpRequest', (_message.Message,), dict(
  DESCRIPTOR = _TXTCMPREQUEST,
  __module__ = 'imageprocess_pb2'
  # @@protoc_insertion_point(class_scope:imageprocess.TxtCmpRequest)
  ))
_sym_db.RegisterMessage(TxtCmpRequest)

ImgCmpRequest = _reflection.GeneratedProtocolMessageType('ImgCmpRequest', (_message.Message,), dict(
  DESCRIPTOR = _IMGCMPREQUEST,
  __module__ = 'imageprocess_pb2'
  # @@protoc_insertion_point(class_scope:imageprocess.ImgCmpRequest)
  ))
_sym_db.RegisterMessage(ImgCmpRequest)
...
try:
  ...
  class ImageStub(object):
    ...
    def __init__(self, channel):
      ...
      self.SSIM = channel.unary_unary(
          ...
          request_serializer=ImgCmpRequest.SerializeToString,
          response_deserializer=FloatReply.FromString,
          )
      self.CosineSim = channel.unary_unary(
          '/imageprocess.Image/CosineSim',
          request_serializer=TxtCmpRequest.SerializeToString,
          response_deserializer=FloatReply.FromString,
          )
      self.reflow_compare_text = channel.unary_unary(
          '/imageprocess.Image/reflow_compare_text',
          request_serializer=ImgCmpRequest.SerializeToString,
          response_deserializer=ReflowTextReply.FromString,
          )
      ...
      self.magic_wand_fill = channel.unary_unary(
          ...
          request_serializer=MagicWandRequest.SerializeToString,
          response_deserializer=ImgReply.FromString,
          )
  ...
  def add_ImageServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'SSIM': grpc.unary_unary_rpc_method_handler(
            servicer.SSIM,
            request_deserializer=ImgCmpRequest.FromString,
            response_serializer=FloatReply.SerializeToString,
        ),
        'CosineSim': grpc.unary_unary_rpc_method_handler(
            servicer.CosineSim,
            request_deserializer=TxtCmpRequest.FromString,
            response_serializer=FloatReply.SerializeToString,
        ),
        'reflow_compare_text': grpc.unary_unary_rpc_method_handler(
            servicer.reflow_compare_text,
            request_deserializer=ImgCmpRequest.FromString,
            response_serializer=ReflowTextReply.SerializeToString,
        ),
        ...
        'magic_wand_fill': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=MagicWandRequest.FromString,
            response_serializer=ImgReply.SerializeToString,
        ),
    }
  ...
  class BetaImageStub(object):
    ...
    def SSIM(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    SSIM.future = None
    def CosineSim(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    CosineSim.future = None
    def reflow_compare_text(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    reflow_compare_text.future = None
    def reflow_compare_image(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    reflow_compare_image.future = None
    def magic_wand_fill(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    magic_wand_fill.future = None
  ...
  def beta_create_Image_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('imageprocess.Image', 'CosineSim'): TxtCmpRequest.FromString,
      ...
      ('imageprocess.Image', 'OCR'): OcrRequest.FromString,
      ('imageprocess.Image', 'SSIM'): ImgCmpRequest.FromString,
      ('imageprocess.Image', 'magic_wand_fill'): MagicWandRequest.FromString,
      ('imageprocess.Image', 'reflow_compare_image'): ImgCmpRequest.FromString,
      ('imageprocess.Image', 'reflow_compare_text'): ImgCmpRequest.FromString,
    }
    response_serializers = {
      ('imageprocess.Image', 'CompareColorHist'): FloatReply.SerializeToString,
      ('imageprocess.Image', 'CosineSim'): FloatReply.SerializeToString,
      ...
      ('imageprocess.Image', 'SSIM'): FloatReply.SerializeToString,
      ('imageprocess.Image', 'magic_wand_fill'): ImgReply.SerializeToString,
      ('imageprocess.Image', 'reflow_compare_image'): FloatReply.SerializeToString,
      ('imageprocess.Image', 'reflow_compare_text'): ReflowTextReply.SerializeToString,
    }
    method_implementations = {
      ('imageprocess.Image', 'CompareColorHist'): face_utilities.unary_unary_inline(servicer.CompareColorHist),
      ('imageprocess.Image', 'CosineSim'): face_utilities.unary_unary_inline(servicer.CosineSim),
      ...
      ('imageprocess.Image', 'SSIM'): face_utilities.unary_unary_inline(servicer.SSIM),
      ('imageprocess.Image', 'magic_wand_fill'): face_utilities.unary_unary_inline(servicer.magic_wand_fill),
      ('imageprocess.Image', 'reflow_compare_image'): face_utilities.unary_unary_inline(servicer.reflow_compare_image),
      ('imageprocess.Image', 'reflow_compare_text'): face_utilities.unary_unary_inline(servicer.reflow_compare_text),
    }
  ...
  def beta_create_Image_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('imageprocess.Image', 'CosineSim'): TxtCmpRequest.SerializeToString,
      ...
      ('imageprocess.Image', 'OCR'): OcrRequest.SerializeToString,
      ('imageprocess.Image', 'SSIM'): ImgCmpRequest.SerializeToString,
      ('imageprocess.Image', 'magic_wand_fill'): MagicWandRequest.SerializeToString,
      ('imageprocess.Image', 'reflow_compare_image'): ImgCmpRequest.SerializeToString,
      ('imageprocess.Image', 'reflow_compare_text'): ImgCmpRequest.SerializeToString,
    }
    response_deserializers = {
      ('imageprocess.Image', 'CompareColorHist'): FloatReply.FromString,
      ('imageprocess.Image', 'CosineSim'): FloatReply.FromString,
      ...
      ('imageprocess.Image', 'SSIM'): FloatReply.FromString,
      ('imageprocess.Image', 'magic_wand_fill'): ImgReply.FromString,
      ('imageprocess.Image', 'reflow_compare_image'): FloatReply.FromString,
      ('imageprocess.Image', 'reflow_compare_text'): ReflowTextReply.FromString,
    }
    cardinalities = {
      'CompareColorHist': cardinality.Cardinality.UNARY_UNARY,
      'CosineSim': cardinality.Cardinality.UNARY_UNARY,
      ...
      'SSIM': cardinality.Cardinality.UNARY_UNARY,
      'magic_wand_fill': cardinality.Cardinality.UNARY_UNARY,
      'reflow_compare_image': cardinality.Cardinality.UNARY_UNARY,
      'reflow_compare_text': cardinality.Cardinality.UNARY_UNARY,
    }
